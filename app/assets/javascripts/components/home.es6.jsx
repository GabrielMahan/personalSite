  ...
  render() {
    return (
      <div id="wrapper">
        ...
        <img id="sm_code" src="assets/octocat.png" className="smBubble" onClick={this.toCenter} ref="github" />
        <img id="sm linkedin" className="smBubble" src="assets/linkedin.png" onClick={this.toCenter} ref="linkedin" />
        <div id="bubble">
